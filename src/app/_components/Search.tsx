...
const SearchInput = () => {
  ...
  const searchHandler = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setSearchResults(searchData.result || []);
  ...
  return (
    <div className="relative w-[381px]">
      ...
      {isPopupVisible && searchResults.length > 0 ? (
        <div ref={popupRef} className="w-[577px] flex p-3 flex-col items-start rounded-[8px] border-[1px] dark:border-[#27272A] dark:bg-[#09090B] bg-white border-[#efefef] absolute z-50 mt-2 ml-[-145px]">
